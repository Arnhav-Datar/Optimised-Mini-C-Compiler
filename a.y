...
%token VOID SWITCH CASE STRUCT BREAK CONTINUE RETURN STRLITERAL CHARLITERAL INC DEC ARROW SIZEOF DEFAULT SCANF PERD
%{
    #include <bits/stdc++.h>
...
scan_stmt: SCANF '(' PERD ',' BITAND identifier ')' ';'  {
                                                                    $1 = new treeNode("SCANF"); $2 = new treeNode("("); $3 = new treeNode("PERD"); $4 = new treeNode(","); 
...
int main() {
    ...
    // printf("%d\n", switchLongestPath);
    // printf("%d\n", mainLongestPath);
    int a = generateIR(lines, lnif);   // generate 3AC intermediate representation
    return 0;
}
